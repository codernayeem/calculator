...
def set_ui(main, backspace_image_link, app_icon):
    ...
    main.setTabOrder(main.exp_label, main.bt_ac)
    main.setTabOrder(main.bt_ac, main.bt_ce)
    main.setTabOrder(main.bt_ce, main.bt_mc)
    main.setTabOrder(main.bt_mc, main.bt_mp)
    main.setTabOrder(main.bt_mp, main.bt_mm)
    main.setTabOrder(main.bt_mm, main.bt_m)
    main.setTabOrder(main.bt_m, main.bt_c)
    main.setTabOrder(main.bt_c, main.bt_root_by_2)
    main.setTabOrder(main.bt_root_by_2, main.bt_root_by_3)
    main.setTabOrder(main.bt_root_by_3, main.bt_square)
    main.setTabOrder(main.bt_square, main.bt_cube)
    main.setTabOrder(main.bt_cube, main.bt_back)
    main.setTabOrder(main.bt_back, main.bt_1)
    main.setTabOrder(main.bt_1, main.bt_2)
    main.setTabOrder(main.bt_2, main.bt_3)
    main.setTabOrder(main.bt_3, main.bt_f_bracket)
    main.setTabOrder(main.bt_f_bracket, main.bt_l_bracket)
    main.setTabOrder(main.bt_l_bracket, main.bt_4)
    main.setTabOrder(main.bt_4, main.bt_5)
    main.setTabOrder(main.bt_5, main.bt_6)
    main.setTabOrder(main.bt_6, main.bt_minus)
    main.setTabOrder(main.bt_minus, main.bt_plus)
    main.setTabOrder(main.bt_plus, main.bt_7)
    main.setTabOrder(main.bt_7, main.bt_8)
    main.setTabOrder(main.bt_8, main.bt_9)
    main.setTabOrder(main.bt_9, main.bt_multiply)
    main.setTabOrder(main.bt_multiply, main.bt_equal)
    main.setTabOrder(main.bt_equal, main.bt_plus_or_minus)
    main.setTabOrder(main.bt_plus_or_minus, main.bt_0)
    main.setTabOrder(main.bt_0, main.bt_dot)
    main.setTabOrder(main.bt_dot, main.bt_divide)
